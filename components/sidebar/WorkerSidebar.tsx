...
export default function WorkerSidebar() {
  ...
  const navItems = [
    { name: "Dashboard", href: "/worker/dashboard", icon: "fa-solid fa-house" },
    { name: "Messages", href: "/worker-messages", icon: "fa-solid fa-message" },
    { name: "Profile", href: "/worker-profile", icon: "fa-solid fa-user" },
  ];
