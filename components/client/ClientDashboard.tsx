...
import {
  ...
  AlertCircle, ArrowUpRight, Zap, ShieldCheck
} from "lucide-react";
    ...
    <section className="animate-in fade-in duration-500 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[#0c4a6e]">
            {userName}
          </h2>
        </div>
        <Link
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          icon={<CalendarCheck className="w-5 h-5 text-[#0284c7]" />}
          color="blue"
        ...
        <StatCard
          ...
          icon={<CreditCard className="w-5 h-5 text-[#f97316]" />}
          color="orange"
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">
                        {booking.workerName || "Awaiting worker"} · {booking.date || "—"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
        ...
        <div className="space-y-2">
          {stats.activeBookings > 0 && (
            <ActivityItem
              ...
              sub="Track progress in My Bookings"
              time="Live"
            />
          )}
          {stats.pendingPayments > 0 && (
            <ActivityItem
              ...
              sub="Review and release from Payments"
              time="Pending"
            />
          )}
          {stats.newMessages > 0 && (
          ...
          {stats.completedJobs > 0 && (
            <ActivityItem
              ...
              sub="Leave a review for your worker"
              time="Done"
            />
          )}
          {stats.activeBookings === 0 && stats.completedJobs === 0 && stats.newMessages === 0 && (
            <ActivityItem
              ...
              sub="Book your first service to get started"
              time="—"
            />
          )}
        </div>
